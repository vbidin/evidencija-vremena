...
(
	ID INT IDENTITY(1,1) PRIMARY KEY,
	PredmetID INT NOT NULL FOREIGN KEY 
		REFERENCES Predmet(ID),
	TipAktivnostiID INT NOT NULL FOREIGN KEY 
		REFERENCES TipAktivnosti(ID),
...
(
	ID INT IDENTITY(1,1) PRIMARY KEY,
	KorisnikID INT NOT NULL FOREIGN KEY 
...
(
	...
	KorisnikID INT NOT NULL FOREIGN KEY 
		REFERENCES Korisnik(ID),
	AktivnostID INT NOT NULL FOREIGN KEY 
